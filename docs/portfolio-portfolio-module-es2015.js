...
ResumeComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ResumeComponent, selectors: [["app-resume"]], decls: 1, vars: 1, consts: [["class", "flex-column align-items-center text-center vw-90 mx-auto", 3, "ngClass", 4, "ngFor", "ngForOf"], [1, "flex-column", "align-items-center", "text-center", "vw-90", "mx-auto", 3, "ngClass"], [1, "mb-5", "current-mode-font-color", 3, "ngClass"], [1, "current-mode-font-color", "bold"], [1, "card", "project-card", "m-3"], ["href", "./assets/images/Manuel_Lemos_CV_2023.pdf", "target", "_blank"], ["src", "./assets/images/Manuel_Lemos_CV_2023.PNG", "alt", "Manuel_Lemos_CV_2023", 1, "resume"], [1, "mt-3", "mb-5", "btn", "bold", "light-border", "current-mode-button", "current-mode-font-color"], ["href", "./assets/images/Manuel_Lemos_CV_2023.pdf", "target", "_blank", 1, "link-button"], [1, "ml-1", "fas", "fa-angle-right"]], template: function ResumeComponent_Template(rf, ctx) { if (rf & 1) {
